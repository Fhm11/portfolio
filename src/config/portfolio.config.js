export const portfolioConfig = {
  ...
  github: "https://github.com/Fhm11",
  linkedin: "https://www.linkedin.com/in/fahim-meziani/",
  
  about: {
    description: "Passionné par le développement web moderne, je transforme mes idées en applications.",
